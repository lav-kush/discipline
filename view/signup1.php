...
<!-- 
		...
		<p><label>Contact No.</label>
		<input class="w3-input w3-border w3-xlarge w3-border-black w3-round-large" type='number' name='fcontact' placeholder="Father's Contact No." onchange="validate_t('fcontact')" required></p><br/>
